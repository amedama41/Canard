#ifndef CANARD_ALTERNATE_CONDITIONAL_P_CENTER_H
#define CANARD_ALTERNATE_CONDITIONAL_P_CENTER_H
...
namespace Canard {
  namespace detail {
    template <class WeightMap, class IndexMap,
      ...
      struct AlternatePCenter {
        AlternatePCenter(std::size_t times, WeightMap w, IndexMap i,
        ...
        template <class Graph, class CenterMap,
          ...
          {
            return alternate_p_center(g, p, times, center_map, w_map, i_map,
  ...
  template <class Graph, class CenterMap, class ExistedCenterMap,
            ...
            class Compare, class Combine, class DistInf, class DistZero>
    typename boost::property_traits<WeightMap>::value_type
    alternate_conditional_p_center
     ...
     Compare compare, Combine combine, DistInf inf, DistZero zero)
    {
      return conditional_p_center(g, p, center_map,
          detail::make_alternate_p_center_func(times, w_map, i_map,
  ...
  template <class Graph, class CenterMap, class ExistedCenterMap,
     ...
     CandidateMap candidate_map, DemandMap demand_map)
    {
      ...
      return alternate_conditional_p_center(g, p, times, center_map,
          existed_center_map, w_map, i_map, candidate_map, demand_map,
...
#endif // CANARD_ALTERNATE_CONDITIONAL_P_CENTER_H
