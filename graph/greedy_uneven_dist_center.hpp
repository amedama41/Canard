     ...
     ExistedCenterMap existed_center_map, CandidateMap candidate_map)
    {
      ...
      Candidate candidate(
          boost::make_filter_iterator(
            cand_map_func, vrange.first,  vrange.second),
          boost::make_filter_iterator(
            cand_map_func, vrange.second, vrange.second));
      ...
      std::fill(
          Canard::make_property_map_iterator(center_map,
            boost::make_filter_iterator(
              existedc_map_func, vrange.first,  vrange.second)),
          Canard::make_property_map_iterator(center_map,
            boost::make_filter_iterator(
              existedc_map_func, vrange.second, vrange.second)),
          false);
